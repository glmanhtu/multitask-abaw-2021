...
class ImbalancedDatasetSamplerVA(torch.utils.data.sampler.Sampler):
    ...
    def __init__(self, dataset, indices=None, num_samples=None):
        ...
        # for value beyond the edges, the function returns len(digitize_num),
        # but it needs to be replaced by len(edges)-1
