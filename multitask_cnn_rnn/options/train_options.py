...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--teacher_nepochs', type=int, default= 40, help='# of epochs to train')
        self._parser.add_argument('--student_nepochs', type=int, default= 40, help='# of epochs for student to train')
        self._parser.add_argument('--n_students', type=int, default= 1, help='# of students')
