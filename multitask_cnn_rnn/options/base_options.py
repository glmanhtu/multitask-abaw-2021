...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self._parser.add_argument('--lambda_teacher', type=float, default=0.4,
                                  help='weight for distillation loss when the ground truth exists (between 0 to 1)')
        ...
        self._parser.add_argument('--lambda_ccc', type=float, default=1.,
                                  help='weight for ccc loss in (CE + lambda_ccc*ccc).')
        ...
        self._parser.add_argument('--use_shared_annotations', action='store_true', help='Debug mode')
        self._parser.add_argument('--audio_mode', action='store_true', help='Enable using audio for training')
        self._parser.add_argument('--audio_n_features', default=64, type=int, help='Number of features')
        self._parser.add_argument('--rnn_split_size', default=0, type=int, help='Split RNN sequence')
